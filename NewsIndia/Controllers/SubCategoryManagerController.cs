...
namespace NewsIndia.Controllers
{
    ...
    public class SubCategoryManagerController : Controller
    {
        ...
        {
            return Json(new { SubCategorySaved = NewsIndiaBAL.SubCategoryManager.SaveSubCategoryInfo(subCategoryId, subCategoryName, isVisible, categoryId) }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(new { IsSubCategoryRemoved = NewsIndiaBAL.SubCategoryManager.RemoveSubCategory(subCategoryId) }, JsonRequestBehavior.AllowGet);
        }
    }
}