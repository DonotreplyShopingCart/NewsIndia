...
namespace NewsIndia.Controllers
{
    ...
    public class CategoryManagerController : Controller
    {
        ...
        {
            return Json(new { CategorySaved = NewsIndiaBAL.CategoryManager.SaveCategoryInfo(categoryId, categoryName, isVisible) }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(new { IsCategoryRemoved = NewsIndiaBAL.CategoryManager.RemoveCategory(categoryId) }, JsonRequestBehavior.AllowGet);
        }
